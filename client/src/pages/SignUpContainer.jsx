    ...
    return (
      <Wrapper>
        <Form onSubmit={handleSubmit}>
          ...
          <Form.Group>
            <FormLabelSet name={"비밀번호 *"} onChange={(event) => handlePassword1(event)} type={"password"} id={"password1"} />
            <FormText name="6자 이상, 영문/숫자/특수문자 포함" />
          </Form.Group>
          <Form.Group>
            <FormLabelSet name={"비밀번호 확인 *"} onChange={(event) => handlePassword2(event)} type={"password"} id={"password2"}/>
          </Form.Group>
          <Form.Group>
            <FormLabelSet name={"이름 *"} onChange={(event) => handleName(event)} type={"name"} />
          </Form.Group>
          <Form.Group>
            <FormLabelSet name={"휴대전화 *"} onChange={(event) => handlePhoneNumber(event)} type={"phoneNumber"} />
          </Form.Group>
          <Form.Group>
          ...
          <Form.Group>
            <FormLabel name={"가입유형 *"} />
            <FormCheck type="radio" label="교수자" name="userType" id="1" onChange={(event) => setUserType(event.target.id)} />
            <FormCheck type="radio" label="학습자" name="userType" id="2" onChange={(event) => setUserType(event.target.id)} />
          </Form.Group>
          <Form.Group>
